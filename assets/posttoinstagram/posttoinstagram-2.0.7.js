(function($, window, undefined) {
     ...
     * @constructor
     */
    function posttoinstagramClient(clientId, accessToken, cacheMediaTime, alternativeApiUrl, isSandbox) {
        /**
         * Instagram Client ID
         * @type {string}
         * @private
    ...
    posttoinstagramClient.prototype = function() {};
    ...
    posttoinstagramClient.prototype._apiUrl = "https://api.instagram.com/v1";
    
    posttoinstagramClient.prototype.getApiUrl = function() {
        if (this._alternativeApiUrl) {
            return this._alternativeApiUrl.replace(/\/*$/, '') + '/';
        }
    
        return posttoinstagramClient.prototype._apiUrl;
    };
    
    posttoinstagramClient.prototype.isAlternativeApi = function() {
        return this.getApiUrl() != posttoinstagramClient.prototype._apiUrl;
    };
    
    posttoinstagramClient.prototype.hasNextPage = function(id) {
        var
            /**
             * Alias to "this"
             * @type {posttoinstagramWidget}
             */
            self = this;
    ...
    posttoinstagramClient.prototype._hasInitialPage = function(id) {
        var
            /**
             * Alias to "this"
             * @type {posttoinstagramWidget}
    ...
    posttoinstagramClient.prototype.resetPagination = function(id) {
        var
            /**
             * Alias to "this"
             * @type {posttoinstagramWidget}
    ...
    posttoinstagramClient.prototype.isLoading = function() {
     ...
     * @returns {$.Deferred}
     */
    posttoinstagramClient.prototype.get = function(url, params, prepApiUrl) {
        var
            /**
    ...
    posttoinstagramClient.prototype.parseQuery = function(qs) {
        return (qs || document.location.search).replace(/(^\?)/,'').split("&").map(function(n){return n = n.split("="),this[n[0]] = n[1],this}.bind({}))[0];
    };
    
    posttoinstagramClient.prototype.getCached = function(key) {
        var
            data,
            q = $.Deferred(),
            self = this;
    ...
    posttoinstagramClient.prototype.cache = function(key, value) {
        var
            self = this,
     ...
     * @returns {$.Deferred}
     */
    posttoinstagramClient.prototype.getUser = function(name) {
        var
            /**
     ...
     * @returns {$.Deferred}
     */
    posttoinstagramClient.prototype.getProfile = function(id) {
     ...
     * @returns {$.Deferred}
     */
    posttoinstagramClient.prototype.getRecentUserMedia = function(id, hashfilter, count) {
        var
            /**
             * Promise to be resolved when all the data will be loaded
             * @type {$.Deferred}
     ...
     * @returns {$.Deferred}
     */
    posttoinstagramClient.prototype.getRecentTagMedia = function(tag, banlist, count) {
        var
            /**
             * Promise to be resolved when all the data will be loaded
             * @type {$.Deferred}
     ...
     * @returns {$.Deferred}
     */
    posttoinstagramClient.prototype.getRecentTagsMedia = function(tags, banlist, count) {
        var
            def = null,
            theardsDef = [],
            nextPages = {},
     ...
     * @returns {*}
     */
    posttoinstagramClient.prototype.loadNextPage = function(id, hashfilter, banlist, count) {
        var
            theardsDef = [],
            /**
             * Promise to be resolved when all the data will be loaded
     ...
     * @private
     */
    posttoinstagramClient.prototype._fetchMedia = function(result, def, posts, left, hashfilter, banlist, id) {
        var
            /**
             * Alias to "this"
             * @type {posttoinstagramWidget}
     ...
     * @constructor
     */
    function posttoinstagramWidget(id, root) {
        var
            /**
             * Alias to "this"
             * @type {posttoinstagramWidget}
        ...
        self._structure = {};
        /**
         * Root DOM element of widget (.posttoinstagram)
         * @type {jQuery}
         */
        ...
        self._properties = {};
        /**
         * posttoinstagramClient instance, provides work with Instagram API
         * @type {posttoinstagramClient}
         * @private
         */
        /**
        ...
        //    self._analytics = new posttoinstagramAnalytics();
        //}
    
        self._api = new posttoinstagramClient(self._params.clientId, self._params.accessToken, parseInt(self._params.cacheMediaTime, 10), self._params.api, self._isSandbox);
    }
    posttoinstagramWidget.prototype = function() {};
    
    posttoinstagramWidget.REGEX_HASHTAG = /[,\s]+/i;
    
    posttoinstagramWidget.VERSION = "2.0.4";
     ...
     * @private
     */
    posttoinstagramWidget.prototype._defaultParams = {
        api: null,
        clientId: "",
        accessToken: "",
        username: "",
     ...
     * @private
     */
    posttoinstagramWidget.prototype._templates = {
        css: "#posttoinstagram_{$id} {width: {$width}; height: {$height}; } #posttoinstagram_{$id}, #posttoinstagram_{$id} .posttoinstagram-feed-wrapper { background: {$contentBgColor} } #posttoinstagram_{$id} .posttoinstagram-header, #posttoinstagram_{$id} a.posttoinstagram-panel-subscribe {background-color: {$bgColor}; } #posttoinstagram_{$id} .posttoinstagram-header-name a, #posttoinstagram_{$id} .posttoinstagram-header-name, #posttoinstagram_{$id} a.posttoinstagram-panel-subscribe {color: {$fontColor}; } #posttoinstagram_{$id} .posttoinstagram-feed-post {width: {$postWidth}; height: {$postHeight}; } #posttoinstagram_{$id} .posttoinstagram-feed-post span {width: {$postImgWidth}; height: {$postImgHeight}; margin-top: {$postImgMTop}; margin-left: {$postImgMLeft} } #posttoinstagram_{$id} .posttoinstagram-feed-loader { width: {$width}; }",
        cap: "<div class=\"\"></div>",
        error: "<div class=\"posttoinstagram-alert\">An error occurred. See console for the details.</div>",
        content: "<div class=\"posttoinstagram-content\"></div>",
        headerUser: "<a class=\"posttoinstagram-header\" href=\"{$url}\" target=\"_blank\"> <img class=\"posttoinstagram-header-pic\" src=\"{$pic}\" alt=\"{$name}\"/> <span class=\"posttoinstagram-header-name\">{$name}</span> <span class=\"posttoinstagram-header-logo\"></span> </a>",
        headerTag: "<div class=\"posttoinstagram-header\"> <span class=\"posttoinstagram-header-name\">{$name}</span> <span class=\"posttoinstagram-header-logo\"></span> </div>",
        panel: "<div class=\"posttoinstagram-panel\"><span class=\"posttoinstagram-panel-posts posttoinstagram-panel-counter\"> <i class=\"posttoinstagram-panel-counter-value\">{$posts}</i><span class=\"posttoinstagram-panel-counter-label\">{~posts}</span> </span><span class=\"posttoinstagram-panel-subsribers posttoinstagram-panel-counter\"> <i class=\"posttoinstagram-panel-counter-value\">{$followers}</i> <span class=\"posttoinstagram-panel-counter-label\">{~followers}</span> </span> <span class=\"posttoinstagram-panel-following posttoinstagram-panel-counter\"> <i class=\"posttoinstagram-panel-counter-value\">{$following}</i> <span class=\"posttoinstagram-panel-counter-label\">{~following}</span> </span> <a class=\"posttoinstagram-panel-subscribe\" href=\"{$url}\" target=\"_blank\">{~follow}</a> </div>",
        scrollbar: "<div class=\"posttoinstagram-scrollbar\"></div>",
        scrollbarSlider: "<div class=\"posttoinstagram-scrollbar-slider\"></div>",
        feedWrapper: "<div class=\"posttoinstagram-feed-wrapper\">",
        feedInner: "<div class=\"posttoinstagram-feed-inner\"></div>",
        feedContainer: "<div class=\"posttoinstagram-feed-container\"></div>",
        feed: "<div class=\"posttoinstagram-feed\"></div>",
        feedLoader: "<div class=\"posttoinstagram-feed-loader\"></div>",
        post: "<a href=\"{$url}\" target=\"_blank\" class=\"posttoinstagram-feed-post\"> <span><img src=\"{$pic}\" alt=\"\"></span> </a>",
        consoleError: "[#posttoinstagram_{$id}: {$message}]"
    };
    /**
     ...
     * @private
     */
    posttoinstagramWidget.prototype._breakpoints = {
        small: [
    ...
    posttoinstagramWidget.prototype._i18n = {
        ru: {
          posts: "публикации",
    ...
    /**
     * Equals to "new posttoinstagramWidget(id, $root)"
     * @param id {number}
     * @param $root {jQuery}
     * @returns {posttoinstagramWidget}
     */
    posttoinstagramWidget.init = function(id, $root) {
        return new posttoinstagramWidget(id, $root);
    };
    /**
     ...
     * @returns {number}
     */
    posttoinstagramWidget.formatNumber = function(n) {
        var
            /**
    ...
    //
    //posttoinstagramWidget.prototype._sendAnalytics = function() {
    //  var
    //      /**
    //       * Alias to "this"
    //       * @type {posttoinstagramWidget}
    ...
    //            params: self._params,
    //            version: posttoinstagramWidget.VERSION
    //        });
    //    }
    //};
    
    posttoinstagramWidget.prototype._defineLanguage = function() {
        var
            /**
             * Alias to "this"
             * @type {posttoinstagramWidget}
     ...
     * @private
     */
    posttoinstagramWidget.prototype._defineParams = function() {
        var
            /**
             * Alias to "this"
             * @type {posttoinstagramWidget}
     ...
     * @private
     */
    posttoinstagramWidget.prototype._defineSource = function() {
        var
            /**
             * Source type in char
             * @type {string}
        ...
        if (self._params.username || self._isSandbox) {
            ...
            if (self._params.hashtag) {
                self._source.hashfilter = self._params.hashtag.split(posttoinstagramWidget.REGEX_HASHTAG);
            }
    
        } else if (self._params.hashtag) {
            self._source.type = "tag";
            self._source.tags = self._params.hashtag.split(posttoinstagramWidget.REGEX_HASHTAG);
        }
    
        if (self._params.ban) {
            self._source.banlist = self._params.ban.split(posttoinstagramWidget.REGEX_HASHTAG);
        }
    };
    /**
     ...
     * @private
     */
    posttoinstagramWidget.prototype._updateStyles = function() {
        var
            imgSize = null,
            /**
             * Alias to "this"
     ...
     * @private
     */
    posttoinstagramWidget.prototype._compileTemplate = function(id, data) {
        var
            /**
             * Original template
             * @type {string}
     ...
     * @private
     */
    posttoinstagramWidget.prototype._setState = function(state) {
        ...
        this._structure.$root
            .removeClass("posttoinstagram-ready posttoinstagram-loading posttoinstagram-error")
            .addClass("posttoinstagram-" + state);
    };
    /**
     * Prepares widget DOM structure and sets initial breakpoint and grid
     * @private
     */
    posttoinstagramWidget.prototype._prepare = function() {
        var
            /**
             * Alias to "this"
             * @type {posttoinstagramWidget}
        ...
        if (self._params.showHeading === "false") {
            self._structure.$root.addClass("posttoinstagram-hide-heading");
        }
    
        self._structure.$root
            .addClass("posttoinstagram")
            .addClass("posttoinstagram-" + self._source.type)
            .addClass("posttoinstagram-image-size-" + self._params.imageSize)
            .attr("id", "posttoinstagram_" + self._id);
    
        if (self._properties.scroll) {
            self._structure.$root.addClass("posttoinstagram-scroll");
        }
     ...
     * @private
     */
    posttoinstagramWidget.prototype._defineBreakpoint = function() {
     ...
     * @private
     */
    posttoinstagramWidget.prototype._defineGrid = function() {
        var
            dusk,
            /**
             * See self._grid
    ...
    posttoinstagramWidget.prototype._undusk = function() {
        var
            $hiddenElement,
            self = this;
     ...
     * @private
     */
    posttoinstagramWidget.prototype._loadFeed = function() {
        var
            /**
             * Promise to be resolved when all the data will be loaded
     ...
     * @private
     */
    posttoinstagramWidget.prototype._setListeners = function() {
        var
            /**
             * Alias to "this"
             * @type {posttoinstagramWidget}
        ...
        $(window).on("resize.posttoinstagram-" + self._id, function() {
            self._adjust();
        });
    
        $(window).on("load.posttoinstagram-" + self._id, function() {
            self._adjust();
        });
     ...
     * @private
     */
    posttoinstagramWidget.prototype._scroll = function() {
        var
            max = null,
            cur = null,
            triggerPoint = null,
     ...
     * @private
     */
    posttoinstagramWidget.prototype._adjust = function() {
        var
            rootWidth = null,
            /**
             * Alias to "this"
        ...
        self._structure.$root.removeClass("posttoinstagram-small posttoinstagram-tiny posttoinstagram-medium posttoinstagram-large");
    
        if (rootWidth > 399) {
            self._structure.$root.addClass("posttoinstagram-large");
        } else if (rootWidth > 299) {
            self._structure.$root.addClass("posttoinstagram-medium");
        } else if (rootWidth <= 209) {
            self._structure.$root.addClass("posttoinstagram-tiny");
        } else if (rootWidth <= 264) {
            self._structure.$root.addClass("posttoinstagram-small");
        }
    
        if (self._structure.$feed) {
            self._structure.$feed.find('.posttoinstagram-feed-post')
                .removeClass('posttoinstagram-feed-post-landscape posttoinstagram-feed-post-portrait posttoinstagram-feed-post-square')
                .each(function(i, item) {
                    ...
                    if (ratio > 1) {
                        $item.addClass('posttoinstagram-feed-post-landscape');
    
                    } else if (ratio < 1) {
                        $item.addClass('posttoinstagram-feed-post-portrait');
    
                    } else {
                        $item.addClass('posttoinstagram-feed-post-square');
                    }
                });
        }
     ...
     * @private
     */
    posttoinstagramWidget.prototype._showScrollbar = function(cur, max) {
        var
            sliderHeight = null,
            sliderOffset = null,
            /**
     ...
     * @private
     */
    posttoinstagramWidget.prototype._log = function(message, setsError) {
        var
            /**
     ...
     */
    posttoinstagramWidget.prototype.run = function () {
        var
            /**
             * Alias to "this"
             * @type {posttoinstagramWidget}
        ...
        if (self._rtl) {
            self._structure.$root.addClass('posttoinstagram-rtl');
        }
     ...
     * @returns {bool}
     */
    posttoinstagramWidget.prototype.updateContent = function() {
        var
            /**
             * Alias to "this"
             * @type {posttoinstagramWidget}
        ...
        if (self._params.showHeading !== "false") {
            if ((self._isSandbox || self._source.type === "user") && self._data.profile) {
                ...
                self._structure.$panel = $(self._compileTemplate("panel", {
                    posts: posttoinstagramWidget.formatNumber(self._data.profile.counts.media),
                    followers: posttoinstagramWidget.formatNumber(self._data.profile.counts.followed_by),
                    following: posttoinstagramWidget.formatNumber(self._data.profile.counts.follows),
                    url: "https://instagram.com/" + self._data.profile.username + "/"
                }));
     ...
     * @returns {boolean}
     */
    posttoinstagramWidget.prototype.updateFeed = function(append) {
        var
            sourceId = null,
            /**
             * Alias to "this"
        ...
        if (self._api.hasNextPage(sourceId)) {
            self._structure.$root.addClass("posttoinstagram-has-pages");
        } else {
            self._structure.$root.removeClass("posttoinstagram-has-pages");
        }
        ...
        $.each(self._data.feed, function(i, item) {
            ...
            if (item.type === "video") {
                $post.addClass("posttoinstagram-feed-post-video");
            }
        ...
        $("img", self._structure.$feed)
            .unbind("load.posttoinstagram-" + self._id)
            .one("load.posttoinstagram-" + self._id, function() {
                $(this).closest(".posttoinstagram-feed-post").addClass('posttoinstagram-feed-post-loaded');
            })
            .each(function() {
                if (this.complete) {
                    $(this).load();
     ...
     * @private
     */
    posttoinstagramWidget.prototype._appendFeed = function(data) {
        var
            sourceId = null,
            /**
             * Alias to "this"
    ...
    function init() {
        $("[data-il]").each(function(i, el) {
            posttoinstagramWidget.init(widgetsCount++, el).run();
        });
    }

    $.fn.posttoinstagram = function(options) {
        var attrs = {};
